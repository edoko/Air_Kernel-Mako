...
static struct l2_level l2_freq_tbl[] __initdata __initdata = {
	[0]  = { {  196000, PLL_8, 0, 2, 0x2E },  900000,  950000, 1 },
	[1]  = { {  286000, HFPLL, 2, 0, 0x00 },  950000,  950000, 2 },
...
#ifdef CONFIG_MSM_CPU_UNDER_AND_OVER_CLOCK
	{ 1, {   196000, PLL_8, 0, 2, 0x2E }, L2(0),   875000 },
	{ 1, {   286000, HFPLL, 2, 0, 0x00 }, L2(5),   900000 },
...
#ifdef CONFIG_MSM_CPU_UNDER_AND_OVER_CLOCK
	{ 1, {   196000, PLL_8, 0, 2, 0x2E }, L2(0),   825000 },
	{ 1, {   286000, HFPLL, 2, 0, 0x00 }, L2(5),   850000 },
...
#ifdef CONFIG_MSM_CPU_UNDER_AND_OVER_CLOCK
	{ 1, {   196000, PLL_8, 0, 2, 0x2E }, L2(0),   775000 },
	{ 1, {   286000, HFPLL, 2, 0, 0x00 }, L2(5),   800000 },
...
#ifdef CONFIG_MSM_CPU_UNDER_AND_OVER_CLOCK
	{ 1, {   196000, PLL_8, 0, 2, 0x2E }, L2(0),   725000 },
	{ 1, {   286000, HFPLL, 2, 0, 0x00 }, L2(5),   750000 },
