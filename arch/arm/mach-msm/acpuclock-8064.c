...
static struct l2_level l2_freq_tbl[] __initdata = {
	...
	[0]  = { {  192000, PLL_8, 0, 0x1C },  950000, 1050000, 1 },
	[1]  = { {  256000, HFPLL, 0, 0x1E },  950000, 1050000, 1 },
	[2]  = { {  384000, HFPLL, 0, 0x00 },  950000, 1050000, 1 },
...
//	[5]  = { {  648000, HFPLL, 1, 0x18 }, 1050000, 1050000, 4 },
	[5]  = { {  702000, HFPLL, 1, 0x1A }, 1150000, 1150000, 4 },
//	[7]  = { {  756000, HFPLL, 1, 0x1C }, 1150000, 1150000, 4 },
//	[8]  = { {  810000, HFPLL, 1, 0x1E }, 1150000, 1150000, 4 },
	[6]  = { {  864000, HFPLL, 1, 0x20 }, 1150000, 1150000, 4 },
...
//	[13] = { { 1080000, HFPLL, 1, 0x28 }, 1150000, 1150000, 5 },
	...
	[9] = { { 1188000, HFPLL, 1, 0x2C }, 1150000, 1150000, 5 },
#else
...
//	[7]  = { {  756000, HFPLL, 1, 0x1C }, 1150000, 1150000, 4 },
//	[8]  = { {  810000, HFPLL, 1, 0x1E }, 1150000, 1150000, 4 },
	[4]  = { {  864000, HFPLL, 1, 0x20 }, 1150000, 1150000, 4 },
//	[10] = { {  918000, HFPLL, 1, 0x22 }, 1150000, 1150000, 5 },
//	[11] = { {  972000, HFPLL, 1, 0x24 }, 1150000, 1150000, 5 },
	[5] = { { 1026000, HFPLL, 1, 0x26 }, 1150000, 1150000, 5 },
//	[13] = { { 1080000, HFPLL, 1, 0x28 }, 1150000, 1150000, 5 },
	[6] = { { 1134000, HFPLL, 1, 0x2A }, 1150000, 1150000, 5 },
	[7] = { { 1188000, HFPLL, 1, 0x2C }, 1150000, 1150000, 5 },
#endif
	{ }
};
...
#ifdef CONFIG_MSM_CPU_LOW_HIGH_CLOCKS
	{ 1, {   192000, PLL_8, 0, 0x1C }, L2(0),   875000 },
	{ 1, {   256000, HFPLL, 0, 0x1E }, L2(0),   900000 },
...
//	{ 1, {   810000, HFPLL, 1, 0x1E }, L2(5),  1050000 },
	{ 1, {   864000, HFPLL, 1, 0x20 }, L2(5),  1075000 },
...
#ifdef CONFIG_MSM_CPU_LOW_HIGH_CLOCKS
	{ 1, {   192000, PLL_8, 0, 0x1C }, L2(0),   825000 },
	{ 1, {   256000, HFPLL, 0, 0x1E }, L2(0),   850000 },
...
//	{ 1, {   810000, HFPLL, 1, 0x1E }, L2(5),  1000000 },
	{ 1, {   864000, HFPLL, 1, 0x20 }, L2(5),  1025000 },
...
//	{ 0, {  1404000, HFPLL, 1, 0x34 }, L2(15), 1162500 },
//	{ 1, {  1458000, HFPLL, 1, 0x36 }, L2(15), 1162500 },
	{ 1, {  1512000, HFPLL, 1, 0x38 }, L2(15), 1175000 },
	{ 1, {  1620000, HFPLL, 1, 0x3C }, L2(15), 1225000 },
	{ 1, {  1722000, HFPLL, 1, 0x40 }, L2(15), 1275000 },
#else
...
#ifdef CONFIG_MSM_CPU_LOW_HIGH_CLOCKS
	{ 1, {   192000, PLL_8, 0, 0x1C }, L2(0),   775000 },
	{ 1, {   256000, HFPLL, 0, 0x1E }, L2(0),   800000 },
...
//	{ 1, {  1458000, HFPLL, 1, 0x36 }, L2(15), 1112500 },
	...
	{ 1, {  1722000, HFPLL, 1, 0x40 }, L2(15), 1225000 },
#else
