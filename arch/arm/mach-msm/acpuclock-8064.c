...
#ifdef CONFIG_MSM_CPU_UNDER_AND_OVER_CLOCK
	[0]  = { {  286000, PLL_8, 0, 2, 0x00 },  950000,  950000, 1 },
...
#ifdef CONFIG_MSM_CPU_UNDER_AND_OVER_CLOCK
	{ 1, {   286000, PLL_8, 0, 2, 0x00 }, L2(0),   900000 },
	{ 1, {   384000, HFPLL, 2, 0, 0x20 }, L2(5),   925000 },
...
#else
	{ 1, {   384000, PLL_8, 0, 2, 0x20 }, L2(0),   925000 },
	{ 1, {   486000, HFPLL, 2, 0, 0x24 }, L2(5),   925000 },
//	{ 0, {   540000, HFPLL, 2, 0, 0x28 }, L2(5),  1000000 },
	{ 1, {   594000, HFPLL, 1, 0, 0x16 }, L2(5),   950000 },
//	{ 0, {   648000, HFPLL, 1, 0, 0x18 }, L2(5),  1025000 },
...
#ifdef CONFIG_MSM_CPU_UNDER_AND_OVER_CLOCK
	{ 1, {   286000, PLL_8, 0, 2, 0x00 }, L2(0),   850000 },
	{ 1, {   384000, HFPLL, 2, 0, 0x20 }, L2(5),   875000 },
...
#else
	{ 1, {   384000, PLL_8, 0, 2, 0x20 }, L2(0),   875000 },
	{ 1, {   486000, HFPLL, 2, 0, 0x24 }, L2(5),   875000 },
//	{ 0, {   540000, HFPLL, 2, 0, 0x28 }, L2(5),   950000 },
	{ 1, {   594000, HFPLL, 1, 0, 0x16 }, L2(5),   900000 },
//	{ 0, {   648000, HFPLL, 1, 0, 0x18 }, L2(5),   975000 },
...
#ifdef CONFIG_MSM_CPU_UNDER_AND_OVER_CLOCK
	{ 1, {   286000, PLL_8, 0, 2, 0x00 }, L2(0),   800000 },
	{ 1, {   384000, HFPLL, 2, 0, 0x20 }, L2(5),   825000 },
...
#else
	{ 1, {   384000, PLL_8, 0, 2, 0x20 }, L2(0),   825000 },
	{ 1, {   486000, HFPLL, 2, 0, 0x24 }, L2(5),   825000 },
//	{ 0, {   540000, HFPLL, 2, 0, 0x28 }, L2(5),   900000 },
	{ 1, {   594000, HFPLL, 1, 0, 0x16 }, L2(5),   850000 },
//	{ 0, {   648000, HFPLL, 1, 0, 0x18 }, L2(5),   925000 },
...
#ifdef CONFIG_MSM_CPU_UNDER_AND_OVER_CLOCK
	{ 1, {   286000, PLL_8, 0, 2, 0x00 }, L2(0),   750000 },
	{ 1, {   384000, HFPLL, 2, 0, 0x20 }, L2(5),   775000 },
...
#else
	{ 1, {   384000, PLL_8, 0, 2, 0x20 }, L2(0),   775000 },
	{ 1, {   486000, HFPLL, 2, 0, 0x24 }, L2(5),   775000 },
//	{ 0, {   540000, HFPLL, 2, 0, 0x28 }, L2(5),   850000 },
	{ 1, {   594000, HFPLL, 1, 0, 0x16 }, L2(5),   800000 },
//	{ 0, {   648000, HFPLL, 1, 0, 0x18 }, L2(5),   875000 },
