...
#ifdef CONFIG_MSM_CPU_UNDER_AND_OVER_CLOCK
	{ 1, {   286000, PLL_8, 0, 2, 0x1E }, L2(0),   925000 },
	{ 1, {   384000, HFPLL, 2, 0, 0x00 }, L2(5),   950000 },
...
//	{ 1, {   810000, HFPLL, 1, 0, 0x1E }, L2(5),  1075000 },
	{ 1, {   864000, HFPLL, 1, 0, 0x20 }, L2(5),  1100000 },
...
//	{ 1, {  1458000, HFPLL, 1, 0, 0x36 }, L2(15), 1237500 },
	...
	{ 1, {  1620000, HFPLL, 1, 0, 0x3A }, L2(15), 1275000 },
	{ 1, {  1722000, HFPLL, 1, 0, 0x3C }, L2(15), 1300000 },
#else
	{ 1, {   384000, HFPLL, 0, 2, 0x00 }, L2(0),   950000 },
//	{ 0, {   432000, HFPLL, 2, 0, 0x20 }, L2(5),   975000 },
	{ 1, {   486000, HFPLL, 2, 0, 0x24 }, L2(5),   975000 },
//	{ 0, {   540000, HFPLL, 2, 0, 0x28 }, L2(5),  1000000 },
	{ 1, {   594000, HFPLL, 1, 0, 0x16 }, L2(5),  1000000 },
