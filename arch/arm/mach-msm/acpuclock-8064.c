...
static struct l2_level l2_freq_tbl[] __initdata __initdata = {
	...
	[0]  = { {  286000, PLL_8, 0, 2, 0x1E },  900000,  950000, 1 },
	[1]  = { {  384000, HFPLL, 2, 0, 0x00 },  950000, 1000000, 2 },
...
//	[4]  = { {  540000, HFPLL, 2, 0, 0x28 }, 1050000, 1050000, 2 },
	[3]  = { {  594000, HFPLL, 1, 0, 0x16 }, 1050000, 1050000, 2 },
//	[6]  = { {  648000, HFPLL, 1, 0, 0x18 }, 1050000, 1050000, 4 },
	[4]  = { {  702000, HFPLL, 1, 0, 0x1A }, 1050000, 1050000, 4 },
//	[8]  = { {  756000, HFPLL, 1, 0, 0x1C }, 1150000, 1150000, 4 },
//	[9]  = { {  810000, HFPLL, 1, 0, 0x1E }, 1150000, 1150000, 4 },
	[5]  = { {  864000, HFPLL, 1, 0, 0x20 }, 1150000, 1150000, 4 },
...
//	[14] = { { 1080000, HFPLL, 1, 0, 0x28 }, 1150000, 1150000, 5 },
	...
	[8] = { { 1188000, HFPLL, 1, 0, 0x2C }, 1150000, 1150000, 5 },
#else
	[0]  = { {  384000, PLL_8, 0, 2, 0x00 },  950000, 1000000, 1 },
//	[2]  = { {  432000, HFPLL, 2, 0, 0x20 }, 1050000, 1050000, 2 },
...
//	[8]  = { {  756000, HFPLL, 1, 0, 0x1C }, 1150000, 1150000, 4 },
//	[9]  = { {  810000, HFPLL, 1, 0, 0x1E }, 1150000, 1150000, 4 },
	[4]  = { {  864000, HFPLL, 1, 0, 0x20 }, 1150000, 1150000, 4 },
//	[11] = { {  918000, HFPLL, 1, 0, 0x22 }, 1150000, 1150000, 5 },
//	[12] = { {  972000, HFPLL, 1, 0, 0x24 }, 1150000, 1150000, 5 },
	[5] = { { 1026000, HFPLL, 1, 0, 0x26 }, 1150000, 1150000, 5 },
//	[14] = { { 1080000, HFPLL, 1, 0, 0x28 }, 1150000, 1150000, 5 },
	[6] = { { 1134000, HFPLL, 1, 0, 0x2A }, 1150000, 1150000, 5 },
	[7] = { { 1188000, HFPLL, 1, 0, 0x2C }, 1150000, 1150000, 5 },
#endif
};

static struct acpu_level acpu_freq_tbl_slow[] __initdata = {
#ifdef CONFIG_MSM_CPU_UNDER_AND_OVER_CLOCK
	{ 1, {   286000, PLL_8, 0, 2, 0x1E }, L2(0),   875000 },
	{ 1, {   384000, HFPLL, 2, 0, 0x00 }, L2(5),   900000 },
//	{ 0, {   432000, HFPLL, 2, 0, 0x20 }, L2(5),   975000 },
...
//	{ 1, {  1458000, HFPLL, 1, 0, 0x36 }, L2(15), 1237500 },
	...
	{ 1, {  1620000, HFPLL, 1, 0, 0x3A }, L2(15), 1225000 },
	{ 1, {  1722000, HFPLL, 1, 0, 0x3C }, L2(15), 1250000 },
#else
...
#ifdef CONFIG_MSM_CPU_UNDER_AND_OVER_CLOCK
	{ 1, {   286000, PLL_8, 0, 2, 0x1E }, L2(0),   825000 },
	{ 1, {   384000, HFPLL, 2, 0, 0x00 }, L2(5),   850000 },
//	{ 0, {   432000, HFPLL, 2, 0, 0x20 }, L2(5),   925000 },
	{ 1, {   486000, HFPLL, 2, 0, 0x24 }, L2(5),   875000 },
//	{ 0, {   540000, HFPLL, 2, 0, 0x28 }, L2(5),   950000 },
	{ 1, {   594000, HFPLL, 1, 0, 0x16 }, L2(5),   900000 },
//	{ 0, {   648000, HFPLL, 1, 0, 0x18 }, L2(5),   975000 },
	{ 1, {   702000, HFPLL, 1, 0, 0x1A }, L2(5),   925000 },
//	{ 0, {   756000, HFPLL, 1, 0, 0x1C }, L2(5),  1025000 },
//	{ 1, {   810000, HFPLL, 1, 0, 0x1E }, L2(5),  1025000 },
	{ 1, {   864000, HFPLL, 1, 0, 0x20 }, L2(5),  1000000 },
//	{ 1, {   918000, HFPLL, 1, 0, 0x22 }, L2(5),  1050000 },
//	{ 0, {   972000, HFPLL, 1, 0, 0x24 }, L2(5),  1075000 },
	{ 1, {  1026000, HFPLL, 1, 0, 0x26 }, L2(5),  1025000 },
...
//	{ 1, {  1458000, HFPLL, 1, 0, 0x36 }, L2(15), 1187500 },
	...
	{ 1, {  1620000, HFPLL, 1, 0, 0x3A }, L2(15), 1175000 },
	{ 1, {  1722000, HFPLL, 1, 0, 0x3C }, L2(15), 1200000 },
#else
...
#ifdef CONFIG_MSM_CPU_UNDER_AND_OVER_CLOCK
	{ 1, {   286000, PLL_8, 0, 2, 0x1E }, L2(0),   775000 },
	{ 1, {   384000, HFPLL, 2, 0, 0x00 }, L2(5),   800000 },
//	{ 0, {   432000, HFPLL, 2, 0, 0x20 }, L2(5),   875000 },
	{ 1, {   486000, HFPLL, 2, 0, 0x24 }, L2(5),   825000 },
//	{ 0, {   540000, HFPLL, 2, 0, 0x28 }, L2(5),   900000 },
	{ 1, {   594000, HFPLL, 1, 0, 0x16 }, L2(5),   850000 },
//	{ 0, {   648000, HFPLL, 1, 0, 0x18 }, L2(5),   925000 },
	{ 1, {   702000, HFPLL, 1, 0, 0x1A }, L2(5),   875000 },
//	{ 0, {   756000, HFPLL, 1, 0, 0x1C }, L2(5),   975000 },
//	{ 1, {   810000, HFPLL, 1, 0, 0x1E }, L2(5),   975000 },
	{ 1, {   864000, HFPLL, 1, 0, 0x20 }, L2(5),   950000 },
//	{ 1, {   918000, HFPLL, 1, 0, 0x22 }, L2(5),  1000000 },
//	{ 0, {   972000, HFPLL, 1, 0, 0x24 }, L2(5),  1025000 },
...
//	{ 1, {  1458000, HFPLL, 1, 0, 0x36 }, L2(15), 1137500 },
	...
	{ 1, {  1620000, HFPLL, 1, 0, 0x3A }, L2(15), 1125000 },
	{ 1, {  1722000, HFPLL, 1, 0, 0x3C }, L2(15), 1150000 },
#else
...
#ifdef CONFIG_MSM_CPU_UNDER_AND_OVER_CLOCK
	{ 1, {   286000, PLL_8, 0, 2, 0x1E }, L2(0),   725000 },
	{ 1, {   384000, HFPLL, 2, 0, 0x00 }, L2(5),   750000 },
//	{ 0, {   432000, HFPLL, 2, 0, 0x20 }, L2(5),   825000 },
	{ 1, {   486000, HFPLL, 2, 0, 0x24 }, L2(5),   775000 },
//	{ 0, {   540000, HFPLL, 2, 0, 0x28 }, L2(5),   850000 },
	{ 1, {   594000, HFPLL, 1, 0, 0x16 }, L2(5),   800000 },
//	{ 0, {   648000, HFPLL, 1, 0, 0x18 }, L2(5),   875000 },
	{ 1, {   702000, HFPLL, 1, 0, 0x1A }, L2(5),   825000 },
//	{ 0, {   756000, HFPLL, 1, 0, 0x1C }, L2(5),   925000 },
//	{ 1, {   810000, HFPLL, 1, 0, 0x1E }, L2(5),   925000 },
	{ 1, {   864000, HFPLL, 1, 0, 0x20 }, L2(5),   900000 },
//	{ 1, {   918000, HFPLL, 1, 0, 0x22 }, L2(5),   950000 },
//	{ 0, {   972000, HFPLL, 1, 0, 0x24 }, L2(5),   975000 },
	{ 1, {  1026000, HFPLL, 1, 0, 0x26 }, L2(5),   925000 },
...
//	{ 1, {  1458000, HFPLL, 1, 0, 0x36 }, L2(15), 1087500 },
	...
	{ 1, {  1620000, HFPLL, 1, 0, 0x3A }, L2(15), 1075000 },
	{ 1, {  1722000, HFPLL, 1, 0, 0x3C }, L2(15), 1100000 },
#else
